...
const iterableSecret = logger.secret([logger.br, 'This is an iterable secret.', logger.br, 'Cool!'], { iterable: true, mask: '' });
const iterableSecretSpread = logger.secret([logger.br, 'This is also an iterable secret, but uses a spread operator.'], { iterable: true, mask: '' });
